...
const ALLOWED_ATTRIBUTES = [
    "align", "class", "colspan", "href", "id", "open",
        ...
        for (const element of elements) {
            ...
            if (/^h[1-6]$/.test(tagName)) {
                ...
                blocks.push({
                    ...
                    text: code,
                    code,
                    language: codeElement ? classLanguage(codeElement) : undefined
                });
...
function buildModel(
    ...
    const sanitizedHtml = DOMPurify.sanitize(rawHtml, {
        ...
        FORBID_ATTR: ["background", "src", "srcset", "poster", "dynsrc", "lowsrc", "ping"]
    });
    ...
    const blocks = parser.parse(Array.from(parsedDocument.body.children), 0);
