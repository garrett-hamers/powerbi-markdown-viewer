...
describe("certification behavior", () => {
    ...
    it("renders a semantic outline and searches logical document content", () => {
        ...
        expect(element.querySelector("h1")?.id).toBe("release-notes");
        expect(element.querySelectorAll("#document-content h2")[0]?.id).toBe("changes");
        expect(element.querySelectorAll("#document-content h2")[1]?.id).toBe("changes-2");
